...

{
  ...
  TString Dir8 ="JetFakeTauMuVVLoose";
  TString Dir9 ="JetFakeTauMuVLoose";
  TString Dir10 ="JetFakeTauMuLoose";
  TString Dir11 ="JetFakeTauMuMedium";
  TString Dir12 ="JetFakeTauMuTight";
  TString Dir13 ="JetFakeTauMuVTight";
  TString Dir14 ="JetFakeTauMuVVTight";
  // *********set up canvas/pad *********                                                                                               
  Bool_t dolog = kTRUE;                                                                                                               
  TString extraname = "";
  ...
  Tau=(Num=="NumTau");
	 ...
	 E->SetTitle("Jet->Tau Fake Rate; Jet Pt(GeV);#epsilon");
      ...
      {                                                                                                                                                                                                                                                                     
       ...
       leg->AddEntry(E8,"#tau_{h} VVLoose Muon Cleaned ", "l");
       leg->AddEntry(E9,"#tau_{h} VLoose Muon Cleaned ", "l");
       leg->AddEntry(E10,"#tau_{h} Loose Muon Cleaned", "l");
       leg->AddEntry(E11,"#tau_{h} Medium Muon Cleaned ", "l");
       leg->AddEntry(E12,"#tau_{h} Tight Muon Cleaned ", "l");
       leg->AddEntry(E13,"#tau_{h} VTight Muon Cleaned ", "l");
       leg->AddEntry(E14,"#tau_{h} VVTight Muon Cleaned ", "l");
  ...
  if(Num=="NumIn")
    {
      ...
      canvas->SaveAs(outpath+"/"+Name+"JetFakeTau_Efficiency_MuonNewTauId.png");
    ...
    {                                                                                                                                                                                                                                                                       
      ...
      //std::string Name=Num.substr(pos);                                                                                                                                                                                                                                     
      //std::cout << "  " << Name <<std::endl;                                                                                                                                                                                                                                
      canvas->SaveAs(outpath+"/JetFakeTau_Efficiency_Muon_NewTauId.png");                                                                                                                                                                                       
    }   
...
void JetFakeTauNumDenomNewTauIdM()
