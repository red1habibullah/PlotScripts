...

{
  ...
  TFile* infile        = new TFile(inpath+"/TauEffDModeEClean_mA20_DMode_Jet_Cleaned_dRTest_Total.root");                                                        
  ...
  //bool VarbinFlag = false;
	...
	E->SetTitle("DecayMode Finding Efficiency for Decay Mode 10 -> 3 Prong; Jet Pt(GeV);#epsilon");
      ...
      {
        E->Draw("AP");
        E->SetTitle("Isolation Efficiency; dR(#tau_{had},#tau_{e});#epsilon");
      }
      ...
      {
        E->Draw("AP");
        E->SetTitle("Isolation Efficiency; Gen #tau_{e} Pt (GeV);#epsilon");
      }
...
void TestSingleFileSingleEffDMode()
