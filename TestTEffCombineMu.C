...
void TestTEffCombineMu(){
  ...
  std::vector<string> Files={"TauEfficiency_MuonAllID_mA4_OldTauID.root","TauEfficiency_MuonAllID_mA5_OldTauID.root","TauEfficiency_MuonAllID_mA7_OldTauID.root","TauEfficiency_MuonAllID_mA9_OldTauID.root","TauEfficiency_MuonAllID_mA12_OldTauID.root","TauEfficiency_MuonAllID_mA13_OldTauID.root","TauEfficiency_MuonAllID_mA16_OldTauID.root","TauEfficiency_MuonAllID_mA19_OldTauID.root","TauEfficiency_MuonAllID_mA20_OldTauID.root"};
  ...
  gPad->Update();                                                                                                                  
  gPad->RedrawAxis();                                                                                                             
  canvas->SaveAs(outpath+"/"+"MuonEfficiencyCombinationTEff_Tau_had.png");
