...

{
  ...
  TFile* infile        = new TFile(inpath+"/JetFakeTau_ZSkim.root");                                                        
  ...
  TString Dir2 ="JetFakeTauE";
  TString Dir3 ="JetFakeTauM";
...
// 
  ...
  gPad->Update();
  gPad->RedrawAxis();
  auto graph3 = E2->GetPaintedGraph();
  graph3->SetMinimum(0);
  ...
  if(Num=="NumIn")
    {
      ...
      canvas->SaveAs(outpath+"/"+Name+"JetFakeTau_Efficiency_test.png");
    ...
    {                                                                                                                                                                                                                                                                       
      ...
      //std::string Name=Num.substr(pos);                                                                                                                                                                                                                                     
      //std::cout << "  " << Name <<std::endl;                                                                                                                                                                                                                                
      canvas->SaveAs(outpath+"/JetFakeTau_Efficiency_test.png");                                                                                                                                                                                       
    }   
