...

{
  ...
  TFile* infile        = new TFile(inpath+"/TauEfficiencyMu_ma5_NewTauID.root");
  ...
  TString Dir8 ="TauEffMuVVLoose";
  TString Dir9 ="TauEffMuVLoose";
  TString Dir10 ="TauEffMuLoose";
  TString Dir11 ="TauEffMuMedium";
  TString Dir12 ="TauEffMuTight";
  TString Dir13 ="TauEffMuVTight";
  TString Dir14 ="TauEffMuVVTight";
...
//TH1F *h3   =(TH1F*)infile3->Get(Dir+"/"+histName)->Clone("h3");
  ...
  //RebinFlag=(histName == "TauEff");
	...
	E->SetTitle("DecayMode Finding Efficiency for Decay Mode 10 -> 3 Prong; Jet Pt(GeV);#epsilon");
      ...
      {
        E->Draw("AP");
        E->SetTitle("#tau_{had} (DecayMode + Isolation) Finding Efficiency; Gen #tau_{#mu} Pt (GeV);#epsilon");
      }
	 ...
	 E->SetTitle("#tau_{had} (DecayMode + Isolation) Finding Efficiency; #tau_{had} Visible Pt (GeV);#epsilon");
       ...
       {
	 E->Draw("AP");
	 E->SetTitle("#tau_{#mu}#tau_{had} Efficiency; #tau_{had} Visible Pt (GeV);#epsilon");
       }
       else if(ComboLep)
      {
        E->Draw("AP");
        E->SetTitle(" #tau_{#mu}#tau_{had} Efficiency; Gen #tau_{#mu} Pt (GeV);#epsilon");
      }
  ...
  leg->AddEntry(E8,"#tau_{h} VVLoose MuonCleaned ", "l");
  leg->AddEntry(E9,"#tau_{h} VLoose MuonCleaned ", "l");
  leg->AddEntry(E10,"#tau_{h} Loose MuonCleaned", "l");
  leg->AddEntry(E11,"#tau_{h} Medium MuonCleaned ", "l");
  leg->AddEntry(E12,"#tau_{h} Tight MucnCleaned ", "l");
  leg->AddEntry(E13,"#tau_{h} VTight MuonCleaned ", "l");
  leg->AddEntry(E14,"#tau_{h} VVTight MuonCleaned ", "l");
  ...
  if(Num=="NumdR")
    {
      ...
      canvas->SaveAs(outpath+"/"+Name+"mA5_Muon_AllID_Comparison_OldTauID.png");
  ...
  else if(Num=="NumTotaldR")
    {
      ...
      std::string Name=Num.substr(pos);
      std::cout << "  " << Name <<std::endl;
      canvas->SaveAs(outpath+"/"+Name+"mA5_Muon_mA5_NewTauID.png");
