std::vector<double> EffVector(string Num,string Denom,string inputfile)
{
  ...
  if(TEfficiency::CheckConsistency(H_Num3,H_Den1))
    {
      E3 = new TEfficiency(H_Num3,H_Den1);
    }
  if(TEfficiency::CheckConsistency(H_Num4,H_Den2))
    {
      E4 = new TEfficiency(H_Num4,H_Den2);
    }


   if(TEfficiency::CheckConsistency(H_Num5,H_Den1))
    {
      E5 = new TEfficiency(H_Num5,H_Den1);
    }

 if(TEfficiency::CheckConsistency(H_Num6,H_Den2))
    {
 ...
 cout<< "TEff6ErrUp :"<< Teff6ErrUp <<endl;
  ...
  double eff3=Int_Num3/Int_Den1;
  double eff4=Int_Num4/Int_Den2;
  double eff5=Int_Num5/Int_Den1;
  double eff6=Int_Num6/Int_Den2;
...
void TestTEffCombineRed(){
  ...
  StdLs.GetYaxis()->SetTitle("#tau_{e}#tau_{h} Total (DecayMode + Isolation) Efficiency");
  ...
  gPad->Update();                                                                                                                  
  gPad->RedrawAxis();                                                                                                             
  canvas->SaveAs(outpath+"/"+"ElectronEfficiencyCombinationTEffRedefine.png");
