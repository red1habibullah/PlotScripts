...

{
  ...
  TString Dir2 ="JetFakeTauELoose";
  TString Dir3 ="JetFakeTauEMedium";
  TString Dir4 ="JetFakeTauETight";
  ...
  Tau=(Num=="NumTau");
    ...
    leg->AddEntry(E2,"#tau_{h} ElectronCleaned Loose Electronon ID", "l");
    leg->AddEntry(E3,"#tau_{h} ElectronCleaned Medium ELectron ID", "l");
    leg->AddEntry(E4,"#tau_{h} ElectronCleaned Tight Electron ID", "l");
  ...
  if(Num=="NumIn")
    {
      ...
      canvas->SaveAs(outpath+"/"+Name+"JetFakeTau_Efficiency_ElectronALLID_Rebin.png");
  ...
  else if(Num=="NumDM")
    {
      ...
      std::string Name=Num.substr(pos);                                                                                                                                                                                                                                      
      std::cout << "  " << Name <<std::endl;                                                                                                                                                                                                                                 
      canvas->SaveAs(outpath+"/"+Name+"JetFakeTau_Efficiency_ElectronALLID.png");
    ...
    {                                                                                                                                                                                                                                                                       
      ...
      //std::string Name=Num.substr(pos);                                                                                                                                                                                                                                     
      //std::cout << "  " << Name <<std::endl;                                                                                                                                                                                                                                
      canvas->SaveAs(outpath+"/JetFakeTau_Efficiency_Electron_ALLID.png");                                                                                                                                                                                       
    }   
