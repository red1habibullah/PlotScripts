std::vector<double> EffVector(string Num,string Denom,string inputfile)
{
 ...
 cout<< "TEff6ErrUp :"<< Teff6ErrUp <<endl;
  ...
  double eff3=Int_Num3/Int_Den3;
  double eff4=Int_Num4/Int_Den4;
  double eff5=Int_Num5/Int_Den5;
  double eff6=Int_Num6/Int_Den6;
...
void TestTEffCombine(){
  using namespace std;
  //std::vector<string> Files={"TauEfficiency_ElectronAllID_mA4_SemiFinal.root","TauEfficiency_ElectronAllID_mA5_SemiFinal.root","TauEfficiency_ElectronAllID_mA7_SemiFinal.root","TauEfficiency_ElectronAllID_mA9_SemiFinal.root","TauEfficiency_ElectronAllID_mA12_SemiFinal.root","TauEfficiency_ElectronAllID_mA13_SemiFinal.root","TauEfficiency_ElectronAllID_mA16_SemiFinal.root","TauEfficiency_ElectronAllID_mA19_SemiFinal.root","TauEfficiency_ElectronAllID_mA20_SemiFinal.root"};
  std::vector<string> Files={"TauEfficiency_ElectronAllID_mA4_OldTauID.root","TauEfficiency_ElectronAllID_mA5_OldTauID.root","TauEfficiency_ElectronAllID_mA7_OldTauID.root","TauEfficiency_ElectronAllID_mA9_OldTauID.root","TauEfficiency_ElectronAllID_mA12_OldTauID.root","TauEfficiency_ElectronAllID_mA13_OldTauID.root","TauEfficiency_ElectronAllID_mA16_OldTauID.root","TauEfficiency_ElectronAllID_mA19_OldTauID.root","TauEfficiency_ElectronAllID_mA20_OldTauID.root"};
  ...
  // canvas->cd();
  TGraphAsymmErrors StdLs(mAPts.size(),&mAPts[0],&StdLoose[0],0,0,&StdLooseLow[0] ,&StdLooseUp[0]);
  TGraphAsymmErrors ClnLs(mAPts.size(),&mAPts[0],&ClnLoose[0],0,0,&ClnLooseLow[0],&ClnLooseUp[0]);
  TGraphAsymmErrors StdMd(mAPts.size(),&mAPts[0],&StdMedium[0],0,0,&StdMediumLow[0],&StdMediumUp[0]);
  TGraphAsymmErrors ClnMd(mAPts.size(),&mAPts[0],&ClnMedium[0],0,0,&ClnMediumLow[0],&ClnMediumUp[0]);
  TGraphAsymmErrors StdTt(mAPts.size(),&mAPts[0],&StdTight[0],0,0,&StdTightLow[0],&StdTightUp[0]);
  TGraphAsymmErrors ClnTt(mAPts.size(),&mAPts[0],&ClnTight[0],0,0,&ClnTightLow[0],&ClnTightUp[0]);
  ...
  StdLs.SetTitle("#tau_{h} Efficiency");
  StdLs.GetXaxis()->SetTitle("m_{a} (Gev)");
  StdLs.GetYaxis()->SetTitle("#tau_{h} Efficiency");
  ...
  leg->AddEntry(&StdLs,"#tau_{h} Loose Electron ID", "l");    
  leg->AddEntry(&ClnLs,"#tau_{h} ElectronCleaned Loose Electron ID", "l");
  leg->AddEntry(&StdMd,"#tau_{h} Medium Electron ID", "l");
  leg->AddEntry(&ClnMd,"#tau_{h} ElectronCleaned Medium Electron ID", "l");
  leg->AddEntry(&StdTt,"#tau_{h} Tight Electron ID", "l");
  leg->AddEntry(&ClnTt,"#tau_{h} ElectronCleaned Tight Electron ID", "l");
  ...
  gPad->Update();                                                                                                                  
  gPad->RedrawAxis();                                                                                                             
  canvas->SaveAs(outpath+"/"+"ElectronEfficiencyCombinationTEff_Tau_had.png");
