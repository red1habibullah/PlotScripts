...

{
  ...
  leg->AddEntry(E2,"#tau_{h} Medium Muon ID ", "l");
  ...
  if(Num=="NumdR")
    {
      ...
      canvas->SaveAs(outpath+"/"+Name+"mA20_MediumMuonID_LooseMuonID_Efficiency_Comparison_New.png");
  ...
  else
    {
      ...
      std::string Name=Num.substr(pos);
      std::cout << "  " << Name <<std::endl;
      canvas->SaveAs(outpath+"/"+Name+"mA20_Cleaned_MediumMuonID_Efficiency_Comparison_New.png");
    }
...
void TestMultipleFileEffCompMu()
