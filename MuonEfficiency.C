...

{
  ...
  TFile* infile        = new TFile(inpath+"/MuonEfficiency_mA5.root");                                                        
  

  TString Dir ="MuEffLoose";
  TString Dir2 ="MuEffMedium";
  TString Dir3 ="MuEffTight";
  ...
  //legend                                                                                                                                                                                                                                                                       
  TLegend *leg = new TLegend(0.60,0.40,0.80,0.60);
  ...
  //RebinFlag=(histName == "TauEff");
	...
	E->SetTitle("DecayMode Finding Efficiency for Decay Mode 10 -> 3 Prong; Jet Pt(GeV);#epsilon");
      ...
      {
        E->Draw("AP");
        E->SetTitle("Muon (Reco+ID) Efficiency; Gen #tau_{mu} Pt (GeV);#epsilon");
      }
  ...
  //Yaxis->Draw();
  leg->AddEntry(E,"Loose Muon ID", "l");
  leg->AddEntry(E2,"Medium Muon ID", "l");
  leg->AddEntry(E3,"Tight Muon ID", "l");
  ...
  if(Num=="NumdR")
    ...
    {
      std::size_t pos = Num.find("M");
      std::string Name=Num.substr(pos);
      std::cout << "  " << Name <<std::endl;
      canvas->SaveAs(outpath+"/"+Name+"mA5_ID_Reco_Efficiency.png");
...

{
  ...
  string DenomMuon="DenomMuon";
  string NumMuon="NumMuon";                                                                                                                                                                                                                                             
  ...
  HistSingleVal(NumMuon,DenomMuon,1);
