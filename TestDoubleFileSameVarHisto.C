//plot two histogram from a 2 rootfilesand plot together  
#include "TString.h"
#include "TH1F.h"
#include "TLatex.h"
#include "TAttLine.h"

void TestDoubleFileSameVarHisto()
{
  using namespace std;
  ...
  TFile* infile        = new TFile(inpath+"/test_Validate_Cut_Mclean.root");//The RootFile with the histogram
  ...
  //legend                                                                                                                                                                                                                                                                       
  TLegend *leg = new TLegend(0.45,0.45,0.75,0.85);
  ...
  leg->AddEntry(h,"slimmedTausMuonCleaned Pre Fix ", "l");
  leg->AddEntry(h2,"slimmedTausMuonCleaned Post Fix", "l");
  leg->Draw();
  ...
  canvas->SaveAs(outpath+"/"+histName+"Fix.png");
